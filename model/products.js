...
module.exports = class Product {
    ...
    updateSingleProduct() {
        return dbConnection.execute(
            'UPDATE products SET prod_name = ?, prod_desc = ?, prod_price = ?, prod_image = ?, prod_gallery = ?, prod_num = ?, ' +
            'prod_cat_id = ?, prod_brand_id = ? WHERE id = ?', [this._name, this._desc, this._price, this._image,
