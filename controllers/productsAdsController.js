...
exports.adsList = asyncMiddleware(async (req, res, next) => {
...
exports.createProductAds = asyncMiddleware(async (req, res, next) => {
...
exports.createSingleProductAds = asyncMiddleware( async(req, res, next) => {
...
exports.editProductIdAds = asyncMiddleware(async(req, res, next) => {
...
exports.editSingleProductAds = asyncMiddleware( async(req, res, next) => {
    if(!req.body) return res.sendStatuc(400);
    const { body } = req;
...
exports.deleteSingleProductAds = asyncMiddleware(async(req, res, next) => {
    const { body } = req;
