...
exports.createProductCat = asyncMiddleware(async (req, res) => {
    const productCat = await ProductsCat.getProductsCat();
...
exports.createSingleProductCat = asyncMiddleware( async(req, res) => {
...
exports.editProductIdCat = asyncMiddleware(async(req, res) => {
...
exports.editSingleProductCat = asyncMiddleware( async(req, res) => {
    if(!req.body) return res.sendStatuc(400);
    const { body } = req;
...
exports.deleteSingleProductCat = asyncMiddleware(async(req, res) => {
