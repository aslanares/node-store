...
exports.brandsList = asyncMiddleware(async (req, res) => {
...
exports.createProductBrand = asyncMiddleware(async (req, res) => {
...
exports.createSingleProductBrand = asyncMiddleware( async(req, res) => {
...
exports.editProductIdBrand = asyncMiddleware(async(req, res) => {
...
exports.editSingleProductBrand = asyncMiddleware( async(req, res) => {
    if(!req.body) return res.sendStatuc(400);
    const { body } = req;
...
exports.deleteSingleProductBrand = asyncMiddleware(async(req, res) => {
